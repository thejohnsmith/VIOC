...
(function (j, o, r) {
    ...
    n = (function () {
        ...
        }(navigator.appName == 'Microsoft Internet Explorer') && !p && (function () {
            var i, h;
            d.start = function () {
                if(!i) {
                    h = j.fn[q].src;
...
// detect IE
var IE = IeVersion();
var IEversion = IE.IsIE ? (IE.CompatibilityMode ? IE.ActingVersion : IE.TrueVersion) : false;
if(IEversion !== false) {
